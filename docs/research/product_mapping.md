...
- [KA-001](docs/research/01_meta_architecture/system_design_philosophy/patterns.md) — BDI Hybrid Architecture
- [KA-005](docs/research/02_agent_orchestration/agent_system_design/patterns.md) — System-Theoretic Decomposition
- [KA-007](docs/research/02_agent_orchestration/agent_system_design/patterns.md) — Mixture-of-Agents
- [KA-010](docs/research/02_agent_orchestration/agent_system_design/patterns.md) — Conditional Multi-Stage Recovery
- [KA-056](docs/research/07_human_interaction/human_in_the_loop_systems/patterns.md) — Autonomy Levels
- [KA-057](docs/research/07_human_interaction/human_in_the_loop_systems/patterns.md) — Confidence-Based Escalation
...
**KNOWLEDGE ATOMS CONSUMED:**
- [KA-022](docs/research/04_code_intelligence/code_exploration/patterns.md) — Semantic-Guided Traversal
- [KA-023](docs/research/04_code_intelligence/code_exploration/patterns.md) — CoSrch Hybrid Search
- [KA-024](docs/research/04_code_intelligence/code_exploration/patterns.md) — Repo Grokking
- [KA-025](docs/research/04_code_intelligence/code_exploration/patterns.md) — File Prioritization
- [KA-019](docs/research/03_context_memory_intelligence/memory_systems/patterns.md) — Vector DB Recall
...
**KNOWLEDGE ATOMS CONSUMED:**
- [KA-002](docs/research/01_meta_architecture/system_design_philosophy/patterns.md) — 4-Phase Spec-Driven Workflow
- [KA-003](docs/research/01_meta_architecture/system_design_philosophy/patterns.md) — Bidirectional Specifications
- [KA-008](docs/research/02_agent_orchestration/task_architecture/patterns.md) — Hierarchical Task Decomposition
- [KA-009](docs/research/02_agent_orchestration/task_architecture/patterns.md) — Worktree Isolation
...
**KNOWLEDGE ATOMS CONSUMED:**
- [KA-015](docs/research/03_context_memory_intelligence/context_management/patterns.md) — Lost-in-Middle (context ordering)
- [KA-027](docs/research/01_meta_architecture/security_architecture/patterns.md) — Hallucination Impact (anti-hallucination)
- [KA-032](docs/research/01_meta_architecture/security_architecture/patterns.md) — Prompt-Only Security (constraints)
...
**KNOWLEDGE ATOMS CONSUMED:**
- [KA-012](docs/research/03_context_memory_intelligence/context_management/patterns.md) — LLMLingua Compression
- [KA-013](docs/research/03_context_memory_intelligence/context_management/patterns.md) — Selective Context
- [KA-015](docs/research/03_context_memory_intelligence/context_management/patterns.md) — Lost-in-Middle
- [KA-016](docs/research/03_context_memory_intelligence/context_management/patterns.md) — Context Poisoning
...
**KNOWLEDGE ATOMS CONSUMED:**
- [KA-008](docs/research/02_agent_orchestration/task_architecture/patterns.md) — Hierarchical Task Decomposition
- [KA-040](docs/research/02_agent_orchestration/task_architecture/patterns.md) — Unlimited Planning (anti-pattern)
...
**KNOWLEDGE ATOMS CONSUMED:**
- [KA-010](docs/research/02_agent_orchestration/agent_system_design/patterns.md) — Conditional Multi-Stage Recovery
- [KA-046](docs/research/05_sdlc_automation/testing_architecture/patterns.md) — AI Happy Path Bias (anti-pattern)
- [KA-079](docs/research/02_agent_orchestration/agent_system_design/patterns.md) — God Agent (anti-pattern)
